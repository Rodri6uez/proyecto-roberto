...
class NoticiaController extends Controller
{
        ...
        
    {
        ...
        $noticias = DB::table('noticias')
            ...
            ->get();return view('noticias.index',['noticias' =>$noticias]);
    }
    ...
    public function create()
    {
       ...
       ->get();return view('noticias.create',['categorias' =>$categorias]);
    ...
    public function show($id)
    {
      ...
      $noticia = DB::table('noticias')
          ...
          ->select('noticias.*', 'categorias.descripcion as categoriadescripcion','users.name as usuario')
          ->first();return view('noticias.show',['noticia' =>$noticia]);
    }
    ...
    public function edit(Noticia $noticia)
    {
        $categorias = Categoria::all()
                 ->sortBy('descripcion', SORT_REGULAR, true);
